report 52048 "Master Roll Report"
{
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/MasterRollReport.rdl';
                ...
                for i := NoOfEarnings + 1 to NoOfEarnings + NoOfDeductions do begin
                    ...
                    if Assignmat.FindSet() then begin
                        ...
                        repeat
                            ...
                            TotalLoanInterest += Assignmat."Loan Interest";
                            //else
                            // + Assignmat."Loan Interest";
                            if Assignmat."Employer Amount" <> 0 then
