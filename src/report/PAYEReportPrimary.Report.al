report 52073 "PAYE Report - Primary"
{
    ApplicationArea = All;
    Caption = 'PAYE Report';
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/PAYEReportPrimary.rdl';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            RequestFilterFields = "Pay Period Filter", "No.", Status, "Secondary Employee", "Employee Type";
