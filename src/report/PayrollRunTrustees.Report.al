report 52074 "Payroll Run Trustees"
{
    ApplicationArea = All;
    ProcessingOnly = true;
    Caption = 'Payroll Run Trustees';
    dataset
    {
        dataitem(Employee; Employee)
        {
            DataItemTableView = sorting("No.") where("Employee Type" = filter("Board Member"), Status = filter(Active));
