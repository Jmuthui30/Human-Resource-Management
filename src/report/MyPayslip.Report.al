report 52069 "My Payslip"
{
    ApplicationArea = All;
    // ArrEarnings[1,1]
    // ArrEarningsAmt[1,1]
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/MyPayslip.rdlc';
    Caption = 'My Payslip';
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            begin
                if Employee."No." <> StaffNo then
                    Error('Kindly Select your staff Number');
    ...
    begin
        MyUserID := UserId;
        if UserSetup.Get(MyUserID) then
