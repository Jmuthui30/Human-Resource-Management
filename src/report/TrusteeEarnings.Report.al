report 52082 "Trustee Earnings"
{
    ApplicationArea = All;
    Caption = 'Earnings';
    DefaultLayout = RDLC;
    RDLCLayout = './src/report_layout/TrusteeEarnings.rdl';
        ...
        dataitem("Payroll PeriodX"; "Payroll Period Trustees")
        {
            ...
            dataitem(Earnings; Earnings)
            {
                ...
                dataitem("Assignment Matrix-X"; "Assignment Matrix")
                {
                    ...
                    DataItemTableView = sorting("Employee No", Type, Code, "Payroll Period", "Reference No") where(Type = const(Earning), "Employee Type" = const(Trustee));
