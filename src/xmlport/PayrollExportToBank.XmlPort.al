xmlport 52005 "Payroll Export To Bank"
{
    ...
    schema
    {
        textelement(Root)
        {
            ...
            tableelement(Employee; Employee)
            {
                ...
                fieldelement(BankCode; Employee."Employee's Bank")
                {
                }
                fieldelement(BranchCode; Employee."Bank Branch")
                {
                }
                fieldelement(AcNo; Employee."Bank Account Number")
                {
                }
                fieldelement(Amount; Employee."Net Pay")
                {
                }
    ...
    begin
        ...
        if PType = '' then
            Error('Please define Payment Type');
